...
dependencies: ["docs/agent/skills/validate_skills.md"]
outputs: []
---
...
## Procedure
0) If the original input prompt is longer or detailed, use reasonable inference to fill out the following ASK steps and confirm with user.
...
9) **Validate**: You must run the validate-skills skill and ensure everything conforms to spec.
