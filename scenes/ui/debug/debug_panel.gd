...
func _ready() -> void:
	...
	_enabled_cb.toggled.connect(func(v: bool) -> void:
		_debug.toggle(&"enabled")
	)
	_show_ui_cb.toggled.connect(func(v: bool) -> void:
		_debug.toggle(&"show_ui")
	)
	_squad_cb.toggled.connect(func(v: bool) -> void:
		_debug.toggle(&"overlay_squad")
	)
	_combatant_cb.toggled.connect(func(v: bool) -> void:
		_debug.toggle(&"overlay_combatant")
	)
	_nav_cb.toggled.connect(func(v: bool) -> void:
		_debug.toggle(&"overlay_navigation")
	)
	_sel_cb.toggled.connect(func(v: bool) -> void:
